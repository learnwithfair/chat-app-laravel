      ...
      <div class="flex-1">
        ...
        >
          ...
          <div class="flex items-center justify-between mt-2">
            <span :class="['text-xs', message.isMine ? 'text-blue-100' : 'text-gray-500']">
              {{ message.time }}
            </span>
        ...
        <div v-if="message.isMine && message.seenBy && message.seenBy.length > 0" class="flex justify-end mt-1">
          <button
        ...
        <MessageReactions
          ...
          @show-details="$emit('show-reactions', $event)"
        />
      </div>
    </div>
  </div>
...
defineEmits(['show-details', 'reply', 'edit', 'forward', 'delete', 'show-reactions', 'show-seen-by']);
</script>