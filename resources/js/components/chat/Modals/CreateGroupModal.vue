...
<template>
  ...
  >
    <div
      @click.stop
      class="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] flex flex-col overflow-hidden"
    >
      <!-- Header - Fixed -->
      ...
      <div class="p-6 space-y-5 overflow-y-auto flex-1 scrollbar-custom">
        ...
        <div>
          ...
          <textarea
            ...
            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none resize-none"
          ></textarea>
        </div>
        ...
        <div>
          ...
          <!-- User list -->
          <div
            class="max-h-48 overflow-y-auto border rounded-lg divide-y scrollbar-custom"
          >
            <div
